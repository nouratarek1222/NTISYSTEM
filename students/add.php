...
if ($_SESSION['role'] == 'user') {
    ...
    <body class='d-flex align-items-center justify-content-center vh-100 bg-light'>
      <div class='alert alert-danger text-center' style='max-width:500px;'>
        ...
        <p>You don't have permission to add a student.</p>
        <hr>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $stmt = $pdo->prepare("INSERT INTO students (name, address, age, gender, id_doctor) VALUES (?,?,?,?,?)");
    $stmt->execute([
        $_POST['name'],
        $_POST['address'],
        $_POST['age'],
...
<div class="container">
  <div class="bg-white p-4 shadow rounded mt-5" style="max-width:500px;margin:auto;">
    <h2 class="text-primary text-center mb-4">Add Student</h2>
    <form method="post">
      <div class="mb-3">
        <label>Name</label>
